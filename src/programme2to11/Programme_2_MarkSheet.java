...
public class Programme_2_MarkSheet {
    public static void main(String[] args) {
        ...
        String result = calculationResult(mathsMarks, scienceMarks, englishMarks);
        String grade = calculateGrade(percentage, result);
        printTheMarksSheet(name, rollNUm, mathsMarks, scienceMarks, englishMarks, total, percentage, result, grade);
        //Closing the scanner object
        scanner.close();
    }
    //calculating the sunm
    public static int sum(int a, int b, int c){
        return a + b + c;
    }
    // calculating the results on subjects marks
    public static String calculationResult(int mathMarks, int scienceMarks, int englishMarks){
    ...
    public static void printTheMarksSheet(String name, int rollNum, int mathsMarks, int scienceMarks, int englishMarks, double total, double percentage, String result, String grade){
        System.out.println("|------------------------------------|");
